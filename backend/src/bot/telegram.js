  ...
  async (ctx) => {
    ...
    try {
      ...
      if (
        ...
        return ctx.reply(
          "This tournament is not accepting entries."
        );
      }
...
💰 Demo Balance: ${tournament.startingDemoBalance}

Payment is required before you can enter.
...
Payment system will be connected next.`
      ...
      await ctx.reply(
        "Unable to process the tournament. Please try again."
      );
    }
  }
);
